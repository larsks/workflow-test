...
from esi_leap.resource_objects.test_node import FakeNode
...
class TestLeaseObject(base.DBTestCase):
    ...
    @mock.patch("esi_leap.resource_objects.test_node.FakeNode.set_lease")
    @mock.patch("esi_leap.objects.lease.Lease.save")
    ...
    @mock.patch("esi_leap.objects.lease.Lease.resource_object")
    @mock.patch("esi_leap.resource_objects.test_node.FakeNode.get_lease_uuid")
    @mock.patch("esi_leap.resource_objects.test_node.FakeNode.remove_lease")
    @mock.patch("esi_leap.objects.lease.Lease.save")
    @mock.patch("esi_leap.common.notification_utils" "._emit_notification")
    def test_cancel(
